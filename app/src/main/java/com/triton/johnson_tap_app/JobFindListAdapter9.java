...
public class JobFindListAdapter9 extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public JobFindListAdapter9(Context context, List<JobnoFindResponse.DataBean> breedTypedataBeanList, PetBreedTypeSelectListener petBreedTypeSelectListener ) {
    ...
    private void initLayoutOne(ViewHolderOne holder, final int position) {
        ...
        Intent intent = new Intent("message_subject_intent9");
        intent.putExtra("cust9" , currentItem.getCUSNAME());
