...
public class JobFindListAdapter5 extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public JobFindListAdapter5(Context context, List<JobnoFindResponse.DataBean> breedTypedataBeanList, PetBreedTypeSelectListener petBreedTypeSelectListener ) {
    ...
    private void initLayoutOne(ViewHolderOne holder, final int position) {
        ...
        Intent intent = new Intent("message_subject_intent5");
        intent.putExtra("cust5" , currentItem.getCUSNAME());
