...
public class JobFindListAdapter7 extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public JobFindListAdapter7(Context context, List<JobnoFindResponse.DataBean> breedTypedataBeanList, PetBreedTypeSelectListener petBreedTypeSelectListener ) {
    ...
    private void initLayoutOne(ViewHolderOne holder, final int position) {
        ...
        Intent intent = new Intent("message_subject_intent7");
        intent.putExtra("cust7" , currentItem.getCUSNAME());
