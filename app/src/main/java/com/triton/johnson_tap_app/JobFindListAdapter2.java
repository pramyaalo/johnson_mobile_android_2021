...
public class JobFindListAdapter2 extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public JobFindListAdapter2(Context context, List<JobnoFindResponse.DataBean> breedTypedataBeanList, PetBreedTypeSelectListener petBreedTypeSelectListener ) {
