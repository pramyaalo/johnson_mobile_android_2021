...
public class JobFindListAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public JobFindListAdapter(Context context, List<JobnoFindResponse.DataBean> breedTypedataBeanList, PetBreedTypeSelectListener petBreedTypeSelectListener ) {
